...
function BaselineSurveyPage({ user = 0 }: { user: number }) {
  ...
  const handleInputValue = (value: string, id?: number) => {
    ...
    <div className="flex flex-col w-full h-full overflow-y-scroll">
      {loading ? (
          ...
          <div className="w-4/5 flex flex-col items-center gap-4 lg:w-3/5 border border-secondary rounded-2xl p-4">
            ...
            <AnimatePresence mode="popLayout">
              <motion.button
                ...
                className="px-8 py-3 border border-secondary rounded-full font-semibold w-4/5 md:w-1/2 uppercase hover:bg-secondary hover:text-white hover:scale-95 cursor-pointer hover:duration-2300 transition"
              >
                Go Back Home
              </motion.button>
            </AnimatePresence>
        ...
        <>
          ...
          <div className="flex flex-col items-center w-full justify-between py-3 gap-3 h-full overflow-y-scroll">
            {/* question  */}
