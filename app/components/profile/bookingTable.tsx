      ...
      <table className="min-w-full bg-white border border-gray-200 shadow-md rounded-lg">
        ...
        <tbody>
          {bookings.map((booking) => (
            <tr key={booking._id} className="border-t test-sm text-slate-600 font-light">
          ...
          {bookings.length === 0 && (
            <tr>
              <td colSpan={8} className="flex items-center justify-center text-center py-4 min-h-[400px] text-gray-500">
