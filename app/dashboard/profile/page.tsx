...
import ChallengeList from "@/app/components/healthChallenge/challengeList";
  ...
  return (
    <div className="w-full flex flex-col gap-6 justify-center items-center">
      ...
      <div className="w-full flex flex-col items-center gap-8">
          ...
          (bookingList?.length < 0 ? (
            ...
            <>
              <div className="flex flex-col items-center justify-center gap-4 h-80 w-full mx-auto">
                <p className="text-slate-500 text-lg">Booking not available</p>
                <Link href={"/dashboard"}>
                  <motion.button
                    whileTap={{ scale: 0.9 }}
        ...
        {activeNav === "My Challenges" && <ChallengeList />}
